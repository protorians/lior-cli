...
// DataDir returns the CLI data directory (~/.lorian-cli), creating it with
...
func DataDir() (string, error) {
	...
	dir := filepath.Join(home, ".lorian-cli")
...
// persisted at ~/.lorian-cli/machine.secret with 0600 permissions; it is
